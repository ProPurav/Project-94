...
export default class SearchBookScreen extends Component {
  constructor() {
    super();
    this.state = {
  ...
  render() {
    ...
    return (
      ...
      <View style={{ flex: 1 }}>
        <View style={{ flex: 0.1 }}>
          <MyHeader title="Search Book" navigation={this.props.navigation} />
        </View>
        <View style={{ flex: 0.9 }}>
          <Input
          ...
          {this.state.showFlatlist ? (
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <Input
                style={styles.formTextInput}
                label={'Board'}
                placeholder={'ICSCE/CBCSE/SSC/IGCSE/IB'}
                containerStyle={{ marginTop: RFValue(20) }}
                onChangeText={(text) => {
                  this.setState({
                    board: text,
              ...
              <TouchableOpacity
                ...
                <Text style={styles.requestbuttontxt}>Search Book</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
